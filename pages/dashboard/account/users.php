...
<body class="theme-light dashboard">
    <main class="container p-4">
        ...
        <div class="page-header mt-3 mb-3" data-aos="fade-down">
            <div class="welcome">User Management
            </div>
        ...
        <section class="cards" id="user_manager_summary"></section>
        ...
        <section class="mt-3 mb-3" id="data-container">
            ...
            <div class="table-responsive mb-3">
                <table id="userTable" class="brand-table default-form">
                    ...
                    <tbody id="userTbody" class="download-section"></tbody>
                </table>
            </div>

            <div id="no-records" class="no-records text-center" style="display:none">No user record match your criteria.</div>
            <div class="pagination" id="pagination"></div>
        </section>
        <div id="no-data" class="no-records text-center mt-4" style="display:none">You have no user account at the moment</div>
    </main>
