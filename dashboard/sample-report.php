    ...
    <section class="content-section">
        ...
        <section class="bg-white">
            <div class="container">
                <div class="row">
                    <div class="col-sm-9">
                        <section class="bg-white padding-default">
                            <section class="sectionSpace" id="outline">
                                ...
                                <div class="flex gap_10 sectionSpace">
                                    ...
                                    <div class="flex gap_10">
                                        ...
                                        <p>APPROVED <span class="orange bold">AUTOInspect
                            ...
                            <section class="bg-white sectionSpace" id="ownership">
                            ...
                            <section class="bg-white sectionSpace" id="odometer">
                                <div class="section-title flex gap_10 space-between  fullwidth">
                                    <h2 class="card-title">Odometer check
                                    </h2>
                                    <p class="p-20">No report found</p>
                                </div>
                                <div class="odometer-check">
                                    <div class="card-data-value">
                                        <div class="data">
                                            <p><span class="bold">Odometer:</span> Not Actual</p>
                                        </div>
                                        <div class="value">
                                            <p><i class="fas fa-check-circle darkgreenColor icon"></i> No problems found</p>
                                        </div>
                                    </div>
                                    <div class="card-data-value">
                                        <div class="data">
                            ...
                            <section class="bg-white sectionSpace" id="safeRecall">
                                <div class="section-title flex gap_10 space-between fullwidth">
                                    <h2 class="card-title">Open safety recall check </h2>
                                    <p class="p-20"><span class="badge bg-danger bg-sm">4</span> problems found</p>
                                </div>
                                <div class="card-body">
                                    <div class="check sectionSpace border-bottom-grey">
                                        <p>
                                            <span class="bold"> Jul 30, 2021</span><br>
                                            21V586000

                                        </p>
                                        <h5>FUEL SYSTEM, DIESEL:DELIVERY:FUEL PUMP</h5>
                            ...
                            <section class="bg-white sectionSpace" id="title">
                                <div class="section-title flex gap_10 space-between  fullwidth">
                                ...
                                <div class="sectionSpace">
                                    <h5>Current Title Information</h5>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                ...
                                <div class="sectionSpace">
                                    <h5>Historical Title Information</h5>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th scope="col">Title Issue Date</th>
                            ...
                            <section class="bg-white sectionSpace" id="theft">
                                <div class="section-title flex gap_10 space-between  fullwidth">
                                ...
                                <div class="card-plain">
                                    <div class="card-body">
                                        <p class="p-20"><i class="fas fa-check-circle darkgreenColor"></i> No records found</p>
                                    </div>
                                </div>
                            </section>

                            <section class="bg-grey sectionSpace padding-20" id="brandcheck">
                                <div class="section-title flex gap_10 space-between  fullwidth">
                                ...
                                <div class="sectionSpace">
                                    <div class="card-data-value">
                                        ...
                                        <div class="value">
                                            <p><i class="fas fa-check-circle darkgreenColor"></i> No problems found</p>
                                        </div>
                                    </div>
                                    <div class="card-data-value">
                                        <div class="data">
                            ...
                            <section class="bg-white sectionSpace" id="sales">
                                <div class="section-title flex gap_10 space-between  fullwidth">
                            ...
                            <section class="sectionSpace" id="analysis">
