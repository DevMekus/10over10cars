  ...
  return (
    <>
      <div className="wrapper">
        <h4 className="color-white">Color manager</h4>
        <p className="color-grey moveup-10">
          Add or remove car colors from the database.
        </p>
        <div className="row">
          <div className="col-sm-5">
            <label className="color-grey">Add Color</label>
            <input
          ...
          <div className="col-sm-6">
            <div className="special-bg padding-20 scrollable feature-box">
              <div className="f-width flex space-between ">
                <p className="color-grey">Black</p>
                <p className="pointer">
                  {" "}
